...
impl FromStr for BuildArgumentKey {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        Ok(BuildArgumentKey(s.to_string()))
    }
}
...
impl FromStr for BuildArgumentValue {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(BuildArgumentValue(s.to_string()))
    }
}

impl From<String> for BuildArgumentValue {
    fn from(s: String) -> Self {
        BuildArgumentValue(s)
    }
}

impl From<&str> for BuildArgumentValue {
    fn from(s: &str) -> Self {
        BuildArgumentValue(s.to_string())
    }
}
...
impl BuildDefinition {
    ...
    pub fn build_arguments_iter<V: Into<BuildArgumentValue>>(
        mut self,
