...
- **Tamper-evident history**: A SHA-256 hash chain over the applied migrations is recorded in the schema dump; `database verify` detects any after-the-fact edit to an already-applied migration
