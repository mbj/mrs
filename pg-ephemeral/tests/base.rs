        ...
        pg_ephemeral::InstanceMap::from([
            (
                ...
                pg_ephemeral::Definition {
                    ...
                    version: pg_ephemeral::Version::new(
                        pg_ephemeral::Major::new(17),
                        pg_ephemeral::Minor::new(1)
                    )
                }
            ),
            (
    ...
    assert_eq!(
        pg_ephemeral::InstanceMap::from([
            (
                ...
                pg_ephemeral::Definition {
                    ...
                    superuser: pg_client::username!("postgres"),
                    version: pg_ephemeral::Version::new(
                        pg_ephemeral::Major::new(18),
                        pg_ephemeral::Minor::new(0)
                    )
                }
            ),
            (
        ...
        pg_ephemeral::Config::load_toml_file(
            ...
            &pg_ephemeral::config::InstanceDefinition {
                ...
                version: Some(pg_ephemeral::Version::new(
                    pg_ephemeral::Major::new(18),
                    pg_ephemeral::Minor::new(0)
                ))
            }
