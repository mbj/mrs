...
pub enum S3BucketSource {
    Static(crate::lambda::S3BucketName),
    StackOutput {
...
pub mod cli {
    ...
    use crate::lambda::S3BucketSource;
    ...
    pub struct Config<'a> {
        ...
        pub target: crate::lambda::Target,
    }
    ...
    impl Config<'_> {
        ...
        async fn load_s3_bucket_name(&self) -> crate::lambda::S3BucketName {
            match &self.s3_bucket_source {
                S3BucketSource::StackOutput {
                    stack_name,
                    output_key,
                } => crate::lambda::S3BucketName(
